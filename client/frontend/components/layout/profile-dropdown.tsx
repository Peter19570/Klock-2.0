...
function Avatar({
  ...
  if (picture) {
    // plain <img>, not next/image — avoids needing remotePatterns config for a backend/S3 host we don't control yet
  ...
  return (
    <div
      className="flex items-center justify-center rounded-full bg-gradient-to-br from-primary to-secondary text-xs font-semibold text-primary-foreground"
      style={{ width: size, height: size }}
    >
  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        {/* mobile: role + theme toggle live here since the navbar hides them on small screens */}
