  ...
  return (
    <section className="mt-10">
      <div className="mb-4 flex items-center justify-between">
        ...
        <Link href="/sessions" className="flex items-center gap-1 text-sm font-medium text-primary hover:underline">
      ...
      {sessions === null ? (
        ...
        <SessionTable sessions={sessions} showUserColumn={role === "ADMIN" || role === "SUPER_ADMIN"} />
      )}
    </section>
  );
}